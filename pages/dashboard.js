  ...
  if (user && !emailVerified) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 text-center p-6">
        ...
        <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Verificando tu cuenta...</h1>
        <p className="text-gray-600 dark:text-gray-400">
          Hemos enviado un enlace a <strong>{user.email}</strong>. Por favor, revisa tu correo para completar el registro.
        </p>
      </div>
    );
  }
